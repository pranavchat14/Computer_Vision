...
# randomly initialize our weight matrix and bias vector -- in a *real* 
# training and classification task, these parameters would be *learned* 
# by our model, but for the sake of this example, let’s use random values
